<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="text-2xl font-bold leading-7 text-slate-900 sm:text-3xl sm:truncate">
                        Empresas en el Municipio de <span
                            class="text-indigo-600">{{ $municipio->nombre_publico ?? $municipio->nombre_interno }}</span>
                    </h1>
                </div>
            </div>
        </div>
        ...
        @if($companies->count() > 0)
            <h2 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Negocios en el Municipio de
                {{ $municipio->nombre_publico ?? $municipio->nombre_interno }}
            </h2>
