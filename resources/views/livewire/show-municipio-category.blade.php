    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div>
                <nav class="flex mb-2 text-sm text-slate-500">
                    <a href="{{ route('municipio.show', $municipio->slug) }}"
                        ...
                        Volver al municipio de {{ $municipio->nombre_publico ?? $municipio->nombre_interno }}
                    </a>
                </nav>
                <h1 class="text-3xl font-bold text-slate-900">
                    {{ $category->nombre }} en {{ $municipio->nombre_publico ?? $municipio->nombre_interno }}
                </h1>
            </div>
        ...
        @else
            <div class="text-center py-16 bg-white rounded-2xl border border-dashed border-slate-300">
                ...
                <p class="mt-1 text-slate-500">No se encontraron empresas de esta categoría en este municipio.</p>
            </div>
        @endif
    </div>
</div>