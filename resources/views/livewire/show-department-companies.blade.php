                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-4 text-sm font-medium text-slate-500">{{ $department->nombre_publico ?? $department->nombre_interno }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach($categories as $category)
                        <a href="{{ route('department.category.show', ['departamento_slug' => $department->slug, 'slug' => $category->slug]) }}"
